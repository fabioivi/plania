...
export default function PlansPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Empty State / Content */}
      <div className="bg-white dark:bg-card rounded-3xl border border-slate-200 dark:border-border p-10 text-center shadow-sm">
        ...
        <h3 className="text-2xl font-black text-slate-900 dark:text-foreground mb-2 tracking-tight">Comece a planejar</h3>
        <p className="text-slate-500 dark:text-muted-foreground max-w-lg mx-auto mb-6 font-medium text-base">
          Você ainda não tem planos salvos. Use nossa Inteligência Artificial para gerar seu primeiro plano de ensino em segundos.
        </p>
        <Link href="/generate">
          <Button size="lg" className="h-12 px-8 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-200 dark:shadow-none text-base">
