  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Meus Planos de Ensino</h1>
          <p className="text-slate-500 mt-2 font-medium">Biblioteca completa de planejamentos.</p>
        </div>
        <Link href="/generate">
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200 p-16 text-center shadow-sm">
        ...
        <h3 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">Comece a planejar</h3>
        <p className="text-slate-500 max-w-lg mx-auto mb-10 font-medium text-lg">
          Você ainda não tem planos salvos. Use nossa Inteligência Artificial para gerar seu primeiro plano de ensino em segundos.
        </p>
        <Link href="/generate">
          <Button size="lg" className="h-16 px-10 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white shadow-xl shadow-indigo-200 text-lg">
